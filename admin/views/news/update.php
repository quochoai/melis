...
<div class="col-md-6">
    <div class="form-group">
        ...
        <textarea name="data[scontent_vi]" id="scontent_vi" rows="6" class="form-control"><?php _e($news['scontent_vi']) ?></textarea>
    </div>
</div>
<div class="col-md-6">
    <div class="form-group">
        <label class="col-form-label" for="name"><?php _e($lang['short_content'].' (Eng)') ?></label>
        <textarea name="data[scontent_en]" id="scontent_en" rows="6" class="form-control"><?php _e($news['scontent_en']) ?></textarea>
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
        <label class="col-form-label" for="name"><?php _e($lang['content_news'].' (Vie)') ?></label><br>
        <textarea name="data[content_vi]" id="content_vi" cols="30" rows="10" class="form-control"><?php _e($news['content_vi'])?></textarea>
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <div class="form-group clearfix">
            ...
            <input type="radio" id="active1" name="data[active]" value="1"<?php if ($news['active'] == 1) _e(' checked') ?> />
            <label for="active1"><?php _e($lang['active']) ?></label>
            </div>
            <div class="icheck-success d-inline">
            <input type="radio" id="active2" name="data[active]" value="0"<?php if ($news['active'] == 0) _e(' checked') ?> />
