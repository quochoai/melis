...
<div class="main_content">
	...
	<script type="text/javascript">
		...
		var backend_list_gallery = "views/gallery/data.php";
		var table_id_gallery = "#galleries";
		var all_page = "<?php _e($lang['all']) ?>";
		var link_delete = "<?php _e($def['link_process_delete']) ?>";
		var link_active = "<?php _e($def['link_process_active']) ?>";
		var link_update_gallery = "<?php _e($def['link_update_gallery']) ?>";
		var link_update_sort = "<?php _e($def['link_process_sort']) ?>";
		var link_add_gallery = "<?php _e($def['link_add_gallery']) ?>";
		...
		var table_gallery = "galleries";
	</script>
	<script src="views/gallery/data_gallery.js"></script>
</div>
