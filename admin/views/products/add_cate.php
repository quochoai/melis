...
<div class="row">
	<div class="col-md-6">
		<div class="form-group">
			...
			<input type="text" class="form-control" name="data[name_vi]" id="name_vi_cate_product" />
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			<label class="col-form-label" for="name"><?php _e($lang['name_category'].' (Eng)') ?></label>
			<input type="text" class="form-control" name="data[name_en]" id="name_en_cate_product" />
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
