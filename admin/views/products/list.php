        ...
        <div class="card">
          <div class="card-header container-fluid">
            <div class="row">
                ...
                <div class="col-md-6"><a class="float-right btn btn-success add" rel="<?php _e($product_id)?>"><i class="fas fa-plus"></i> <?php _e($lang['addnew']) ?></a><a class="float-right btn btn-success mr-2" id="sort"><i class="fas fa-sort"></i> <?php _e($lang['update_sort']) ?></a><a class="float-right btn btn-success mr-2 reload"><i class="fas fa-sync"></i> <?php _e($lang['reload']) ?></a><a class="float-right btn btn-success mr-2 category_product"><i class="fas fa-undo"></i> <?php _e($lang['back']) ?></a></div>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
...
<script type="text/javascript">
    ...
    var link_active_product = "<?php _e($def['link_active_product']) ?>";
