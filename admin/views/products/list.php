...
<div class="main_content">
	...
	<script type="text/javascript">
		...
		var link_update_product = "<?php _e($def['link_update_product']) ?>";
		var link_update_sort = "<?php _e($def['link_process_sort']) ?>";
		var link_add_product = "<?php _e($def['link_add_product']) ?>";
		...
		var table_product = "products";
	</script>
	<script src="views/products/data_product.js"></script>
</div>
