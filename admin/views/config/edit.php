...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$(document).on('click', '#update', function(){
			let eTieuDeVi = $('#tieude_vi');
			let eTieuDeEn = $('#tieude_en_t');
			var tieude_vi = $.trim(eTieuDeVi.val());
			var tieude_en = $.trim(eTieuDeEn.val());
			if (tieude_vi == '') {
				toastr.error("<?php echo $lang['not_title_website_vi'] ?>");
				eTieuDeVi.addClass('is-invalid');
				eTieuDeVi.focus();
				return false;
			} else {
				eTieuDeVi.removeClass('is-invalid');
				eTieuDeVi.addClass('is-valid');
			}
			if (tieude_en == '') {
				toastr.error("<?php echo $lang['not_title_website_en'] ?>");
				eTieuDeEn.addClass('is-invalid');
				eTieuDeEn.focus();
				return false;
			} else {
				eTieuDeEn.removeClass('is-invalid');
				eTieuDeEn.addClass('is-valid');
			}
