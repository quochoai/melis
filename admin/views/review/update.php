<?php
	...
	$id = $_POST['id'];
	$table = "reviews";
	$review = $h->getById("rv_id, customer_vi, customer_en, image, content_vi, content_en, show_home, sort, active, title_vi, title_en, desc_vi, desc_en, keyw_vi, keyw_en", $table, $id, "and deleted_at is null");
	$rv_id = $review['rv_id'];
	if ($rv_id == 1)
...
?>
<input type="hidden" name="rv_id" id="rv_id_e" value="<?php _e($rv_id) ?>" />
<input type="hidden" name="id" id="id_rv_e" value="<?php _e($id) ?>" />
<div class="col-md-6">
	<div class="form-group">
		<label class="col-form-label" for="name"><?php _e($lang['customer_name'].' (Vie)') ?></label>
		<input type="text" class="form-control" name="data[customer_vi]" id="customer_vi_e" value="<?php _e($review['customer_vi']) ?>" />
	</div>
</div>
<div class="col-md-6">
	<div class="form-group">
		<label class="col-form-label" for="name"><?php _e($lang['customer_name'].' (Eng)') ?></label>
		<input type="text" class="form-control" name="data[customer_en]" id="customer_en_e" value="<?php _e($review['customer_en']) ?>" />
	</div>
</div>
<div class="col-md-12">
	<div class="form-group">
...
<div class="col-md-6">
	<div class="form-group">
		...
		<input type="text" class="form-control" name="data[title_vi]" id="title_vi_e" value="<?php _e($review['title_vi']) ?>"/>
	</div>
</div>
<div class="col-md-6">
	<div class="form-group">
		<label class="col-form-label" for="name"><?php _e($lang['title_website'].' (Eng)') ?></label>
		<input type="text" class="form-control" name="data[title_en]" id="title_en_e" value="<?php _e($review['title_en']) ?>"/>
	</div>
</div>
<div class="col-md-6">
	<div class="form-group">
		<label class="col-form-label" for="name"><?php _e($lang['description'].' (Vie)') ?></label>
		<textarea class="form-control" name="data[desc_vi]" id="desc_vi_e" rows="4"><?php _e($review['desc_vi']) ?></textarea>
	</div>
</div>
<div class="col-md-6">
	<div class="form-group">
		<label class="col-form-label" for="name"><?php _e($lang['description'].' (Eng)') ?></label>
		<textarea class="form-control" name="data[desc_en]" id="desc_en_e" rows="4"><?php _e($review['desc_en']) ?></textarea>
	</div>
</div>
<div class="col-md-6">
	<div class="form-group">
		<label class="col-form-label" for="name"><?php _e($lang['keyword'].' (Vie)') ?></label>
		<textarea class="form-control" name="data[keyw_vi]" id="keyw_vi_e" rows="4"><?php _e($review['keyw_vi']) ?></textarea>
	</div>
</div>
<div class="col-md-6">
	<div class="form-group">
		<label class="col-form-label" for="name"><?php _e($lang['keyword'].' (Eng)') ?></label>
		<textarea class="form-control" name="data[keyw_en]" id="keyw_en_e" rows="4"><?php _e($review['keyw_en']) ?></textarea>
	</div>
</div>
<div class="col-md-4">
	<div class="form-group">
		<label class="col-form-label" for="name"><?php echo $lang['sort'] ?></label>
		<input type="number" class="form-control" name="data[sort]" id="sorts_e" value="<?php _e($review['sort']) ?>" step="1" min="1" />
	</div>
</div>
<div class="col-md-4">
	<div class="form-group">
		...
		<div class="form-group clearfix">
			...
			<input type="radio" id="active1_e" name="data[active]" value="1"<?php if ($review['active'] == 1) _e(' checked') ?> />
			<label for="active1_e"><?php _e($lang['active']) ?></label>
			</div>
			<div class="icheck-success d-inline">
			<input type="radio" id="active2_e" name="data[active]" value="0"<?php if ($review['active'] == 0) _e(' checked') ?> />
			<label for="active2_e"><?php _e($lang['hidden']) ?></label>
			</div>
		</div>
	</div>
</div>
<div class="col-md-4">
	<div class="form-group">
		...
		<div class="form-group clearfix">
		<div class="icheck-success d-inline">
			<input type="radio" id="show_home11" name="data[show_home]" value="1"<?php _e(($review['show_home'] == 1) ? ' checked' : '') ?> />
			<label for="show_home11"><?php _e($lang['active']) ?></label>
		</div>
		<div class="icheck-success d-inline">
			<input type="radio" id="show_home22" name="data[show_home]" value="0"<?php _e(($review['show_home'] != 1) ? ' checked' : '') ?> />
			<label for="show_home22"><?php _e($lang['hidden']) ?></label>
		</div>
		</div>
	</div>
</div>
