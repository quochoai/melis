...
<div class="col-md-6">
	<div class="form-group">
		...
		<input type="text" class="form-control" name="data[name_vi]" id="name_vi_landing_e" value="<?php _e($landing['name_vi']) ?>" />
	</div>
</div>
<div class="col-md-6">
	<div class="form-group">
		<label class="col-form-label" for="name"><?php _e($lang['title_news'].' (Eng)') ?></label>
		<input type="text" class="form-control" name="data[name_en]" id="name_en_landing_e" value="<?php _e($landing['name_en']) ?>" />
	</div>
</div>
<div class="col-md-12">
	<div class="form-group">
