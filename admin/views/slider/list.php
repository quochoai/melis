...
<div class="main_content">
	...
	<script type="text/javascript">
		...
		var backend_list_slider = "views/slider/data.php";
		var table_id_slider = "#sliders";
		var all_page = "<?php _e($lang['all']) ?>";
		var link_delete = "<?php _e($def['link_process_delete']) ?>";
		var link_active = "<?php _e($def['link_process_active']) ?>";
		var link_update_slider = "<?php _e($def['link_update_slider']) ?>";
		var link_update_sort = "<?php _e($def['link_process_sort']) ?>";
		var link_add_slider = "<?php _e($def['link_add_slider']) ?>";
		...
		var table_slider = "sliders";
	</script>
	<script src="views/slider/data_slider.js"></script>
</div>
