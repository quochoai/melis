...
<div class="main_content">
    ...
    <script type="text/javascript">
        ...
        var backend_list = "views/partner/data.php";
        ...
        var link_update = "<?php _e($def['link_update_partner']) ?>";
        var link_update_sort = "<?php _e($def['link_process_sort']) ?>";
        var link_add = "<?php _e($def['link_add_partner']) ?>";
    ...
    <script src="views/partner/data.js"></script>
</div>
