...
<div class="col-md-6">
	<div class="form-group">
		...
		<input type="text" class="form-control" name="data[name_vi]" id="name_vi_partner_e" value="<?php _e($partner['name_vi']) ?>" />
	</div>
</div>
<div class="col-md-6">
	<div class="form-group">
		<label class="col-form-label" for="name"><?php _e($lang['name_partner'].' (Eng)') ?></label>
		<input type="text" class="form-control" name="data[name_en]" id="name_en_partner_e" value="<?php _e($partner['name_en']) ?>" />
	</div>
</div>
<div class="col-md-6">
	<div class="form-group">
