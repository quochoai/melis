                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="select2-green">
                                <select class="form-control select2 select2-green" data-dropdown-css-class="select2-green" name="department_id[]" id="department_id" style="width: 100%;" multiple="multiple">
