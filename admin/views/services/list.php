...
<div class="main_content">
	...
	<script type="text/javascript">
		...
		var backend_list_service = "views/services/data.php";
		var table_id_service = "#services";
		var all_page = "<?php _e($lang['all']) ?>";
		var link_delete = "<?php _e($def['link_process_delete']) ?>";
		var link_active = "<?php _e($def['link_process_active']) ?>";
		var link_update_service = "<?php _e($def['link_service_update']) ?>";
		var link_update_sort = "<?php _e($def['link_process_sort']) ?>";
		var link_add_service = "<?php _e($def['link_service_add']) ?>";
