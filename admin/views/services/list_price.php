...
<div class="main_content">
	...
	<script type="text/javascript">
		...
		var backend_list_price = "views/services/data_price.php";
		var table_id_price = "#price_services";
		var all_page = "<?php _e($lang['all']) ?>";
		var link_delete = "<?php _e($def['link_process_delete']) ?>";
		var link_active = "<?php _e($def['link_process_active']) ?>";
		var link_update_price = "<?php _e($def['link_price_service_update']) ?>";
		var link_update_sort = "<?php _e($def['link_process_sort']) ?>";
		var link_add_price = "<?php _e($def['link_price_service_add']) ?>";
