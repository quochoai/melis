...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="data[name_vi]" id="name_vi_service_e" value="<?php _e($service['name_vi']) ?>" />
    </div>
</div>
<div class="col-md-6">
    <div class="form-group">
        <label class="col-form-label" for="name"><?php _e($lang['name_service'].' (Eng)') ?></label>
        <input type="text" class="form-control" name="data[name_en]" id="name_en_service_e" value="<?php _e($service['name_en']) ?>" />
    </div>
</div>
<div class="col-md-4">
    <div class="form-group">
...
<div class="col-md-12">
    <div class="form-group">
        ...
        <textarea name="data[hieuqua_vi]" id="hieuqua_vi_service_e" class="form-control"><?php _e($service['hieuqua_vi'])?></textarea>
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
        <label class="col-form-label" for="name"><?php _e($lang['hieuqua'].' (Eng)') ?></label>
        <textarea name="data[hieuqua_en]" id="hieuqua_en_service_e" class="form-control"><?php _e($service['hieuqua_en']) ?></textarea>
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
        <label class="col-form-label" for="name"><?php _e($lang['nguyenly'].' (Vie)') ?></label>
        <textarea name="data[nguyenly_vi]" id="nguyenly_vi_service_e" class="form-control"><?php _e($service['nguyenly_vi']) ?></textarea>
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
        <label class="col-form-label" for="name"><?php _e($lang['nguyenly'].' (Eng)') ?></label>
        <textarea name="data[nguyenly_en]" id="nguyenly_en_service_e" class="form-control"><?php _e($service['nguyenly_en']) ?></textarea>
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
        <label class="col-form-label" for="name"><?php _e($lang['khachhangtrainghiem'].' (Vie)') ?></label>
        <textarea name="data[khtn_vi]" id="khtn_vi_service_e" class="form-control"><?php _e($service['khtn_vi']) ?></textarea>
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
        <label class="col-form-label" for="name"><?php _e($lang['khachhangtrainghiem'].' (Eng)') ?></label>
        <textarea name="data[khtn_en]" id="khtn_en_service_e" class="form-control"><?php _e($service['khtn_en']) ?></textarea>
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
        <label class="col-form-label" for="name"><?php _e($lang['uudiemkhimuataimelis'].' (Vie)') ?></label>
        <textarea name="data[uudiem_vi]" id="uudiem_vi_service_e" class="form-control"><?php _e($service['uudiem_vi']) ?></textarea>
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
        <label class="col-form-label" for="name"><?php _e($lang['uudiemkhimuataimelis'].' (Eng)') ?></label>
        <textarea name="data[uudiem_en]" id="uudiem_en_service_e" class="form-control"><?php _e($service['uudiem_en']) ?></textarea>
    </div>
</div>
<div class="col-md-4">
    <div class="form-group">
...
<script type="text/javascript">
    tinymce.init({
        selector: "textarea#uudiem_vi_service_e, textarea#uudiem_en_service_e, textarea#nguyenly_vi_service_e, textarea#nguyenly_en_service_e, textarea#hieuqua_vi_service_e, textarea#hieuqua_en_service_e, textarea#khtn_vi_service_e, textarea#khtn_en_service_e",
        theme: "modern",
        width: 750,
        height: 300,
        plugins: [
